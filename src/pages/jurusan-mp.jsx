  ...
  return (
    <div className="w-full bg-white font-sans flex flex-col">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 md:px-6 py-10">
        <div className="w-full bg-gradient-to-r from-[#352f5b] to-[#1a1b41] rounded-sm py-16 px-8 md:px-12 shadow-md">
      ...
      <section className="w-full max-w-6xl mx-auto px-6 py-20 bg-white mb-10">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-start pl-0 md:pl-4">
            <div className="bg-[#352F5B] text-white text-[10px] md:text-[11px] font-bold tracking-widest px-4 py-1.5 rounded-full mb-6 uppercase">
              RPL / TIK
            </div>
            ...
            <a href="#" className="flex items-center gap-2 text-[#352F5B] font-bold text-[13px] md:text-sm hover:text-blue-800 transition-colors">
              Pusat Teknologi
